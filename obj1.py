...
#     def __init__(self,fname,lname,salary):   # instance properties/variable...
#         self.fname=fname 
#         self.lname=lname
#         self.salary=salary
...
# class employee:
#     increment=1.4 #Class variable/properties 
#     def __init__(self,fname,lname,salary):   # instance properties/variables
#         self.fname=fname 
#         self.lname=lname
#         self.salary=salary
#         self.increment=1.8
...
#         self.salary=self.salary*employee.increment # Here it'll directly check for the  class Variable/property
...
# print(Amartya.__dict__) # To print all instance  class properties/variable...
# Abhinav.employee_no=33432 # To define an instance Class property/variable...
...
#     def __init__(self,fname,lname,salary):   # instance defined Class property/variable
#         self.fname=fname 
#         self.lname=lname
#         self.salary=salary
...
# print(Amartya.salary)
# employee.change_increment(4)  # instance  (changing the value of variable)
# Amartya.increased()
# print(Amartya.salary)
...
#      # to delete value of properies of the function"email"...
#     @email.deleter
#     def email(self):
#         self.fname=None
#         self.lname=None
